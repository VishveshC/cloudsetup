...
## **Speeds**:
I personally have not tested maximum upload/download speeds; however if my obersvations are something to refer, maximum down speeds are in the range of 100Mbps (Megabytes/sec) and up speeds are in the range of 10~20Mbps (Megabytes/sec). Note that these speeds are in Megabytes/s, not megabits/s. That translates to around a **10 gigabit** download connection! These speeds are however subject to peer availability ofcourse.
